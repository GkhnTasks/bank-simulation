...
@Component
public class TransactionSrviceImpl implements TransactionService {
    ...
    public TransactionSrviceImpl(AccountRepository accountRepository) {
    ...
    if (checkSenderBalance(sender,amount)){
        ...
        throw  new BalanceNotSufficientException("Balance is not in the" +
                "enough for this transactiob");
    }
    }

    private boolean checkSenderBalance(Account sender, BigDecimal amount) {
    return  sender.getBalance().subtract(amount)
    ...
    private void validateAccounts(Account sender, Account receiver) {
         if (sender==null || receiver==null){
             ...
             throw new BadRequestException("Sender or receiver can not" +
                     "be null");
         }

         if (sender.getId().equals(receiver.getId())){
             throw new BadRequestException("Sender account must to be" +
                     "different from receiver account");
         }
    ...
    private void checkAccountOwnerShip(Account sender, Account receiver) {
        ...
        && !sender.getUserId().equals(receiver.getUserId())){
            throw new AccountOwnerShipException("When one of the account type is" +
                    "SAVINGS,sender and receiver has to be same person");
        }
    }
